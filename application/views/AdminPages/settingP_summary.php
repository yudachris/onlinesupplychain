...
<html>
    ...
    <div class='row'>
        ...
        <div class='row'>
            ...
            <button type='button' data-toggle='modal' data-target='#demands' class='btn btn-primary'><span class='glyphicon glyphicon-search'></span> Show Preset <br>Demands</button>
            <br>
            <br>
            <a href="<?php echo base_url();?>admin/resetP"><button class='btn btn-warning'><span class='glyphicon glyphicon-refresh'></span> Reset Setting</button></a>
            </div>
            <div class='col-lg-6 col-md-6 col-sm-6'>
              <form action="<?php echo base_url();?>admin/startgameP" method='post'>
                  <input type='hidden' name='g_name' value="<?php echo $g_name; ?>">
                  <input type='hidden' name='g_pass' value="<?php echo $g_pass; ?>">
                  <input type='hidden' name='g_diff' value="<?php echo $g_diff;?>">
    ...
    <div class='modal fade' id='demands' role='dialog'>
    <div class='modal-dialog'>
    <div class='modal-content'>
    <div class='modal-header'>
      <button type='button' class='close' data-dismiss='modal'>&times;</button>
      <h4 class='modal-title'><strong>Preset</strong> Demands</h4>
    </div>
